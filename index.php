...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Bus2Go</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Marg To Sharm El Sheikh Bus</h1>

            <p class="text-center">The website is designed to provide users with a user-friendly interface, making it easy to navigate and access bus schedules. This simplicity enhances the overall commuting experience, allowing individuals to efficiently plan their trips without unnecessary complications.</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                public transportation in Egypt is a vital part of the country's social and economic infrastructure. It serves millions of people every day,
                 providing an affordable and convenient way to get around. however, the public transportation system in Egypt is also under considerable strain. it is facing several challenges, including overcrowding.</p><br>
                 <p>So , we made this website application to facilitate the puplic Transportation in Egypt </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
  ...
  <div class="container">
    <div class="row gy-4">
      <div class="col-lg-5 col-md-12 footer-info">
        ...
        <p>The website is designed to provide users with a user-friendly interface, making it easy to navigate and access bus schedules. This simplicity enhances the overall commuting experience, allowing individuals to efficiently plan their trips without unnecessary complications.</p>
      ...
      <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
        ...
        <p>
          ...
          <strong>Phone:</strong> +20 01122441507<br>
          <strong>Email:</strong> debsummerscaler@gmail.com<br>
        </p>
...
<div class="footer-legal">
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong><span>Bus2Go</span></strong>. All Rights Reserved
    </div>
    <div class="credits">

      Designed by <a href="#">Mohamed Raaft</a>
    </div>
  </div>
</div>
